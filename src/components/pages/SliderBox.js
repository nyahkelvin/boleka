            ...
            <div className="container">
                ...
                <div className="col-md-6">
                    ...
                    <tr>
                        ...
                        <table >
                            ...
                            <td className="valignMiddle">
                                <img src="http://boleka.co.za/images/Apps-calc-icon.png" alt="calculator" width="64" height="64" />
                            </td>
                            <td className="valignMiddle">
                                <strong>
                                ...
                                <a href="login.html"> sign in</a> .</small>
                            </td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <tr>
                        ...
                        <span id="js-display-change-month" className="calculator-text"> Repayment period: {duration} Month(s)</span>
                        <br />
